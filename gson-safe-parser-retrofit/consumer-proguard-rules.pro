# GsonSafeParser Retrofit AAR repeats the framework rules so direct Retrofit consumers
# receive the same Android keep baseline even before transitive rules are inspected.
